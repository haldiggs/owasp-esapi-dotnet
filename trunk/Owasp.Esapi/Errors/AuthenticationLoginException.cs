...
namespace Owasp.Esapi.Errors
{
    ...
    /// </author>
    [Serializable]
    public class AuthenticationLoginException : AuthenticationException
    {
        ...
        protected internal AuthenticationLoginException()
        {
            // hidden
        }
        ...
        /// </param>
        public AuthenticationLoginException(string userMessage, string logMessage, Exception cause)
